...
class TopoNetMapGraph(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        super(TopoNetMapGraph, self).__init__(**kwargs)
        ...
        if bbox_head is not None:
            if self.train_cfg is not None:
                ...
                bbox_head.update(train_cfg=None)
        ...
        if lane_head is not None:
            if self.train_cfg is not None:
                ...
                lane_head.update(train_cfg=None)
    ...
    def forward_train(self,
        ...
        if self.video_test_mode:
            ...
            prev_bev = None
        assert prev_bev is None, "prev_bev isn't none???"
    ...
    def forward_test(self, img_metas, img=None, map_graph=None, **kwargs):
        ...
        if not self.video_test_mode:
            self.prev_frame_info['prev_bev'] = None
        assert self.prev_frame_info['prev_bev'] is None, "prev_bev isn't none???"
