...
class BaselineMapGraph(MVXTwoStageDetector):
    ...
    def forward_test(self, img_metas, img=None, map_graph=None, **kwargs):
        ...
        new_prev_bev, results_list = self.simple_test(
            img_metas, img, map_graph, prev_bev=None, **kwargs)
        return results_list
    ...
    def simple_test_pts(self, x, map_x, img_metas, img=None, prev_bev=None, rescale=False):
        ...
        bev_feats = self.bev_constructor(x, img_metas, map_graph_feats=map_x, prev_bev=prev_bev)
    ...
    def simple_test(self, img_metas, img=None, map_graph=None, prev_bev=None, rescale=False, **kwargs):
        ...
        # get bev features of SD map raster
        map_graph_feats = self.extract_map_feat(map_graph=map_graph, **kwargs)
        # if self.map_encoder_type == 'VectorNet':
        #     map_graph_feats = self.extract_map_feat(map_graph=map_graph, **kwargs)
        # else:
